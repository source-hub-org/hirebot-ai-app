...
export default function Result() {
  ...
  const result = {
    ...
    timeSpent: "25:30",
    feedback:
      "Bạn đã thể hiện kiến thức tốt về JavaScript. Tuy nhiên, cần cải thiện thêm về các khái niệm nâng cao như closure và promise chaining.",
      ...
      <div className="container mx-auto">
        <div className="quiz-card text-center">
          ...
          <div className="mb-8">
            ...
            <p className="bg-gray-50 p-4 rounded text-left">
              {result.feedback}
            </p>
          </div>
