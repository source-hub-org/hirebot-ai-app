...
export default function QuestionsList() {
  ...
  useEffect(() => {
    ...
    if (filters.language) {
      result = result.filter(question => question.language === filters.language);
    }
  ...
  const handleOptionChange = (optionId: string, field: 'text' | 'correct', value: string | boolean) => {
    setNewQuestion(prev => ({
      ...prev,
                        ...
                        <input 
                          ...
                          onChange={() => {
                            ...
                            newQuestion.options.forEach(opt => {
                              handleOptionChange(opt.id, 'correct', opt.id === option.id);
                            });
                          }}
                          className="w-4 h-4"
                        />
