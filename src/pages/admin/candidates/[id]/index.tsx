...
export default function CandidateDetail() {
  ...
  const candidateResult = {
    ...
    answers: [
      { question: 'JavaScript là ngôn ngữ lập trình gì?', answer: 'Interpreted', correct: true },
      { question: 'Sự khác biệt giữa let và var?', answer: 'Block scope vs function scope', correct: true },
      { question: 'Closure trong JS là gì?', answer: 'Function có thể truy cập biến bên ngoài scope của nó', correct: true },
      { question: 'Promise là gì?', answer: 'Đối tượng đại diện cho giá trị có thể có hoặc không có ở tương lai', correct: true },
      { question: 'Event loop hoạt động thế nào?', answer: 'Sai', correct: false },
    ]
  };
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Chi tiết kết quả: {candidateResult.name}</h1>
        <div className="flex gap-2">
          <button className="bg-blue-500 text-white px-4 py-2 rounded">Xuất PDF</button>
          <button className="bg-green-500 text-white px-4 py-2 rounded">Xuất CSV</button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-purple-50 p-4 rounded">
            ...
            <p className="text-2xl font-bold">{candidateResult.essayScore}/100</p>
          </div>
          <div className="bg-green-50 p-4 rounded">
            <p className="text-gray-600">Tổng điểm:</p>
            <p className="text-2xl font-bold">{candidateResult.totalScore}/100</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {candidateResult.answers.map((item, index) => (
              <div key={index} className={`p-4 rounded ${item.correct ? 'bg-green-50' : 'bg-red-50'}`}>
