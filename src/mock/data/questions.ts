export const questions = [
  ...
  { 
    ...
    options: [
      ...
      { id: 'd', text: 'Tất cả đều đúng trong một số trường hợp', correct: true },
    ]
  },
  { 
    id: 6, 
    ...
    options: [
      ...
      { id: 'c', text: 'Một hàm có thể truy cập các biến từ scope bên ngoài của nó, ngay cả khi scope đó đã kết thúc', correct: true },
  ...
  { 
    id: 8, 
    question: 'Phương thức nào được sử dụng để chuyển đổi một đối tượng JavaScript thành chuỗi JSON?', 
    type: 'MCQ',
    language: 'JavaScript',
    level: 'Junior',
    options: [
  ...
  { 
    id: 9, 
    question: 'Trong React, hooks nào được sử dụng để lưu trữ state trong functional component?', 
    type: 'MCQ',
    language: 'JavaScript',
    level: 'Senior',
    options: [
  ...
  { 
    ...
    level: 'Senior',
    options: [
      { id: 'a', text: 'Khi một sự kiện xảy ra trên một phần tử, nó sẽ lan truyền lên các phần tử cha', correct: true },
      { id: 'b', text: 'Khi một sự kiện xảy ra trên một phần tử, nó sẽ lan truyền xuống các phần tử con' },
  ...
  { 
    id: 11, 
    question: 'Giải thích cách hoạt động của Event Loop trong JavaScript và vai trò của nó trong mô hình bất đồng bộ.', 
    type: 'Essay',
    language: 'JavaScript',
    level: 'Senior',
  },
  { 
    id: 12, 
    question: 'Phân tích ưu nhược điểm của các phương pháp quản lý state trong React (useState, useReducer, Context API, Redux). Khi nào nên sử dụng mỗi phương pháp?', 
    type: 'Essay',
    language: 'JavaScript',
    level: 'Senior',
  },
  { 
    id: 13, 
    question: 'Trong Python, phương thức nào được sử dụng để sao chép một list?', 
    type: 'MCQ',
    language: 'Python',
    level: 'Junior',
    options: [
  ...
  { 
    ...
    level: 'Junior',
    options: [
      { id: 'a', text: 'Tạo một list mới từ một iterable hiện có', correct: true },
  ...
  { 
    id: 15, 
    question: 'Phân biệt giữa shallow copy và deep copy trong Python. Cung cấp ví dụ minh họa.', 
    type: 'Essay',
    language: 'Python',
    level: 'Middle',
  },
  ...
  { 
    id: 17, 
    question: 'Trong C#, từ khóa nào được sử dụng để khai báo một lớp không thể kế thừa?', 
    type: 'MCQ',
    language: 'C#',
    level: 'Middle',
    options: [
  ...
  { 
    ...
    level: 'Middle',
    options: [
      { id: 'a', text: 'Truy vấn và thao tác dữ liệu từ các nguồn khác nhau', correct: true },
  ...
  { 
    id: 19, 
    question: 'Giải thích các design pattern phổ biến trong Java và khi nào nên sử dụng chúng.', 
    type: 'Essay',
    language: 'Java',
    level: 'Senior',
  },
  { 
    id: 20, 
    question: 'Phân tích ưu nhược điểm của microservices so với monolithic architecture. Khi nào nên sử dụng mỗi kiến trúc?', 
    type: 'Essay',
    language: 'C#',
    level: 'Senior',
  },
